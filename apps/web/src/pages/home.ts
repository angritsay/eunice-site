  ...
  ${audiences(ctx, [
    {
      ...
      text: 'An agent does the messy work, chasing the data down and checking it’s right. IDD, ODD, and monitoring.',
      to: 'private-markets/lps',
    },
    {
      desk: 'private-markets',
      title: 'Fund managers',
      text: 'The same ODD questionnaire, asked eleven ways, by eleven different LPs.',
      to: 'private-markets/managers',
    },
    {
      desk: 'private-markets',
      title: 'Family offices',
      text: 'Run the diligence of a full team, whatever the size of yours. Fewer people, same rigor, better decisions.',
      to: 'private-markets/family-offices',
    },
    {
      desk: 'digital-assets',
      title: 'Exchanges',
      text: 'A listing queue that grows faster than the team reviewing it.',
      to: 'digital-assets/exchanges',
    },
    {
      desk: 'digital-assets',
      title: 'Custodians and market makers',
      text: 'You hold the asset. You are the last to hear when something moves.',
      to: 'digital-assets/custodians',
    },
    {
      desk: 'token-disclosure',
      title: 'Issuers and their counsel',
